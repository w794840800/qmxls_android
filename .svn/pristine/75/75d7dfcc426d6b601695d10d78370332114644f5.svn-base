...
public class ViceGoodsSelectAdapter extends RecyclerView.Adapter<ViceGoodsSelectAdapter.GoodsSelectViewHolder> {
    ...
    public ViceGoodsSelectAdapter(Context context, ArrayList<goodsBean> goodsBeanArrayList) {
